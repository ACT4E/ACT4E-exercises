...
\begin{exercise}[Opposite]
  ...
  \methodsource{FiniteRelationOperations}{transitive_closure}
...
\begin{exercise}
  ...
  \methodsource{FinitePosetSubsetProperties}{chain}
\end{exercise}

\begin{exercise}
  Check if a subset is an antichain.
  \methodsource{FinitePosetSubsetProperties}{antichain}
\end{exercise}
...
\datafilefig{prof1}{prof1.poset.yaml}{fig:prof1}
